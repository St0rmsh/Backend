...
import { ShieldCheck, ShieldAlert, FileText, BarChart3, ChevronDown, ChevronUp, Info } from "lucide-react";
...
const AIInsightsPanel = ({ video }) => {
  ...
  const { summary, claims, finalVerdict, confidence, trustScore } = video.verification || {};
            ...
            <div className="p-6 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="p-4 bg-stitch-grey rounded-2xl border border-border-main">
                  ...
                  <div className="text-xl font-display font-black">{(confidence * 100 || 0).toFixed(0)}%</div>
                  <div className="w-full h-1 bg-gray-200 mt-2 rounded-full overflow-hidden">
                    <div className="h-full bg-brand-orange" style={{ width: `${confidence * 100}%` }}></div>
                  </div>
                </div>
                ...
                <div className="p-4 bg-stitch-grey rounded-2xl border border-border-main">
                  ...
                  <div className="text-xl font-display font-black">{trustScore || 0}</div>
                  <div className="w-full h-1 bg-gray-200 mt-2 rounded-full overflow-hidden">
