...
export const Input = ({ label, icon: Icon, className = "", ...props }) => (
  <div className="space-y-2 w-full">
    ...
    <div className="relative group">
      ...
      <input
        className={`w-full ${Icon ? 'pl-12' : 'px-5'} pr-5 py-3 rounded-2xl bg-surface-low border border-main text-main placeholder:text-muted/50 focus:ring-2 focus:ring-brand-orange/30 focus:border-brand-orange/40 outline-none transition-all duration-300 ${className}`}
        {...props}
      />
    </div>
  </div>
