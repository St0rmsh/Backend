...
const ForensicButton = ({ children, variant = "primary", className = "", ...props }) => {
    ...
    return (
        <button 
            className={`px-6 py-2.5 text-[11px] font-bold uppercase tracking-widest transition-all duration-200 active:scale-[0.98] ${variants[variant]} ${className}`}
            {...props}
        >
            {children}
        </button>
            ...
            <div className="min-h-screen bg-[#0A0A0A] flex flex-col items-center justify-center p-8 selection:bg-white selection:text-black">
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="max-w-xl w-full space-y-12">
                    <div className="space-y-4 text-center">
                        <div className="w-20 h-20 bg-white/[0.03] border border-white/10 rounded-sm flex items-center justify-center mx-auto text-white">
                    ...
                    <GlassContainer className="p-10 space-y-8">
                        ...
                        <ForensicButton className="w-full py-5" onClick={async () => {
                            if(!createForm.name || !createForm.handle) return toast.error("Information required");
                            ...
                            try {
                                ...
                                loadAllData();
                            } catch(e) { toast.error("Failed to create channel", { id: tid }); }
                        }}>
                            Create Channel
                        </ForensicButton>
                    </GlassContainer>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-[10px] font-medium text-zinc-500 leading-relaxed uppercase tracking-wider">
                                        Active nodes: <span className="text-white">128</span><br />
                                ...
                                {filteredVideos.length > 0 ? (
                                        ...
                                        <tr key={v._id} className="group hover:bg-white/[0.01] transition-colors">
                                            ...
                                            <td className="py-8 px-4 text-right">
                                                <div className="flex justify-end gap-4 opacity-0 group-hover:opacity-100 transition-all">
                                                    ...
                                                    <button onClick={() => handleDeleteVideo(v._id)} className="text-zinc-800 hover:text-red-500 transition-colors"><Trash2 size={14} /></button>
                                                </div>
                                            </td>
                                        </tr>
                                    ))
                                    ...
                                    <tr>
                                        <td colSpan="5" className="py-20 text-center">
                                            <p className="text-[10px] font-bold uppercase tracking-[0.4em] text-zinc-600">No signals found matching your parameters</p>
                                        </td>
                                    </tr>
                                )}
                            </tbody>
                ...
                <AnimatePresence>
                    ...
                    {showUpload && (
                        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 overflow-y-auto no-scrollbar">
                            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} onClick={() => setShowUpload(false)} className="fixed inset-0 bg-black/95 backdrop-blur-md" />
                            <motion.div initial={{ scale: 0.98, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.98, opacity: 0 }} className="relative bg-[#0A0A0A] border border-white/10 rounded-sm w-full max-w-5xl p-10 sm:p-16 shadow-2xl space-y-12">
                                <div className="flex justify-between items-start">
                                    ...
                                    <button onClick={() => setShowUpload(false)} className="text-zinc-500 hover:text-white transition-all"><X size={24} /></button>
                                </div>
                                    ...
                                    <div className="flex flex-col justify-between">
                                        ...
                                        <div className="pt-10 border-t border-white/5">
                                            {uploadProgress > 0 ? (
                                                ...
                                                <ForensicButton className="w-full py-6" onClick={handleUpload}>Upload Video</ForensicButton>
                                            )}
                                        </div>
                                    </div>
                                </div>
                    ...
                    {showEditVideo && (
                        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
                            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} onClick={() => setShowEditVideo(null)} className="fixed inset-0 bg-black/95 backdrop-blur-md" />
                            <motion.div initial={{ scale: 0.98, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.98, opacity: 0 }} className="relative bg-[#0A0A0A] border border-white/10 rounded-sm w-full max-w-3xl p-12 shadow-2xl space-y-10">
                                <div className="flex justify-between items-start">
                                    ...
                                    <button onClick={() => setShowEditVideo(null)} className="text-zinc-500 hover:text-white transition-all"><X size={20} /></button>
                                </div>
                                ...
                                <div className="flex flex-col gap-4 pt-4">
                                    <ForensicButton className="w-full py-5" onClick={handleEditVideo}>Save Changes</ForensicButton>
                                    {!confirmDelete ? (
                                        ...
                                        <div className="flex items-center justify-between p-6 bg-red-500/5 border border-red-500/10">
                                            ...
                                            <div className="flex gap-4">
                                                ...
                                                <button onClick={() => handleDeleteVideo(showEditVideo._id)} className="text-[9px] font-bold uppercase text-red-500 border border-red-500/20 px-4 py-2 hover:bg-red-500 hover:text-white transition-all">Delete</button>
                                            </div>
                                        </div>
                                    )}
                                </div>
                    ...
                    {showEdit && (
                        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
                            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} onClick={() => setShowEdit(false)} className="fixed inset-0 bg-black/95 backdrop-blur-md" />
                            <motion.div initial={{ scale: 0.98, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.98, opacity: 0 }} className="relative bg-[#0A0A0A] border border-white/10 rounded-sm w-full max-w-2xl p-12 shadow-2xl space-y-12">
                                <div className="flex justify-between items-start">
                                    ...
                                    <button onClick={() => setShowEdit(false)} className="text-zinc-500 hover:text-white transition-all"><X size={20} /></button>
                                </div>
                                ...
                                <div className="space-y-10">
                                    <div className="relative aspect-[4/1] bg-white/[0.02] border border-white/5 overflow-hidden group">
                                        ...
                                        <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all">
                                            <ForensicButton variant="ghost" onClick={() => bannerRef.current.click()}>Update Banner</ForensicButton>
                                        </div>
                                        <div className="absolute -bottom-6 left-10 w-24 h-24 bg-[#0A0A0A] border border-white/10 flex items-center justify-center overflow-hidden">
                                            ...
                                            <div onClick={() => avatarRef.current.click()} className="absolute inset-0 bg-black/60 opacity-0 hover:opacity-100 flex items-center justify-center cursor-pointer transition-all">
                                                <ImageIcon size={20} />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <ForensicButton className="w-full py-6" onClick={handleUpdateChannel}>Save Changes</ForensicButton>
                                </div>
                            </motion.div>
                        </div>
                    )}
