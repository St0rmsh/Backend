...
import { Brain, Zap, Shield, Trophy, Sparkles, RotateCcw, MessageSquareText } from 'lucide-react';
...
function App() {
  ...
  const handleSend = async (problem) => {
    ...
    try {
      ...
      const judgeData = data.judgement || {};
            ...
            >
              ...
              <div className="space-y-2 max-w-md">
                ...
                <p className="text-sm text-(--text-secondary) leading-relaxed">
                  Two models compete, a third judges the results. Ask a follow-up
                  afterward — the arena remembers the conversation.
                </p>
              </div>
            </motion.div>
          )}
